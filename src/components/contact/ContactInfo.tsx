...
const ContactInfo = () => {
  return (
    <div className="bg-gradient-to-br from-primary-900 to-primary-800 text-white rounded-xl shadow-xl p-8 md:p-10 h-full relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-500 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2"></div>
      </div>
          ...
          <div className="transform hover:translate-x-2 transition-transform duration-300">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">Lavington Mall, James Gichuru Rd</p>
              </div>
            </div>
          </div>
          
          <div className="transform hover:translate-x-2 transition-transform duration-300">
            <a href="tel:+254722707415" className="flex items-start group">
              ...
              <div>
                ...
                <p className="text-gray-300">0722 707 415 / 0717 478 857</p>
              </div>
            </a>
          </div>
          
          <div className="transform hover:translate-x-2 transition-transform duration-300">
            <a href="mailto:info@zeniainternational.com" className="flex items-start group">
              <div className="bg-white/10 p-3 rounded-lg mr-4 group-hover:bg-white/20 transition-colors">
                <Mail className="h-6 w-6" />
              </div>
              <div>
                <h4 className="font-medium text-lg mb-1">Email Address</h4>
                <p className="text-gray-300">info@zeniainternational.com</p>
              </div>
            </a>
          </div>
